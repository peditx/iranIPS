...
while true; do
    if [ -f "/etc/init.d/passwall" ] && [ -f "/etc/init.d/passwall2" ]; then
        ...
        OPTION=$(whiptail --title "PeDitX’s EZPasswall v3.1.1" --menu "Choose an option:" 18 60 10 \
            ...
            "10" "Uninstall all Tools" \
            --cancel-button "Exit" \
            3>&1 1>&2 2>&3)
    elif [ -f "/etc/init.d/passwall" ]; then
        # Only Passwall 1 installed
        OPTION=$(whiptail --title "PeDitX’s EZPasswall v3.1.1" --menu "Choose an option:" 18 60 9 \
            "1" "Install Passwall 1" \
            "2" "Install Passwall 2" \
            "3" "Install Passwall 1 + 2" \
            "4" "Update Passwall 1" \
        ...
        OPTION=$(whiptail --title "PeDitX’s EZPasswall v3.1.1" --menu "Choose an option:" 18 60 8 \
            "1" "Install Passwall 1" \
            "2" "Install Passwall 2" \
            "3" "Install Passwall 1 + 2" \
            "7" "Easy Exroot" \
