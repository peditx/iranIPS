#!/bin/sh
# Passwall 2 Snapshot Installer for PeDitXOS (APK + OPKG)

echo ">>> Installing Passwall 2 (Snapshot)..."
...
if [ -f /etc/init.d/passwall2 ]; then
    echo "[*] Passwall 2 (Snapshot) installed successfully"
else
